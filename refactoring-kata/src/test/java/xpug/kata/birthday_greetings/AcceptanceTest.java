...
public class AcceptanceTest {
	...
	private void startBirthdayServiceFor(String employeeFileName, String date) throws Exception {
        ...
        EmployeeRepository employeeRepository = new EmployeeRepository(employeeFileName);
        service.sendGreetings(employeeRepository, new XDate(date), "localhost", NONSTANDARD_PORT);
