...
public class BirthdayService {
	...
	public void sendGreetings(EmployeeRepository employeeRepository, XDate xDate, String smtpHost, int smtpPort) throws IOException, ParseException, AddressException, MessagingException {
